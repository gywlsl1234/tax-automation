...
export function CumulativeLineChart({ title, cumulative, color, unit = "원" }: CumulativeLineChartProps) {
  const data = cumulative.map((value, idx) => ({ month: `${idx + 1}월`, value }));
